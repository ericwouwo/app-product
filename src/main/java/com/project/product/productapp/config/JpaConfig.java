package com.project.product.productapp.config;
...
@EnableJpaRepositories(basePackages = {"com.project.product.productapp"})
...
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        em.setPackagesToScan("com.project.product.productapp.entities");
